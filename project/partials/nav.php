...
<ul class="nav">
    ...
    <?php if (has_role("Admin")): ?>
        ...
        <li><a href="<?php echo getURL('test/test_list_accounts.php'); ?>">View Account</a></li>
        <li><a href="<?php echo getURL('test/test_create_transactions.php'); ?>">Create Transaction</a></li>
        <li><a href="<?php echo getURL('test/test_list_transactions.php'); ?>">View Transactions</a></li>
    <?php endif; ?>
    <?php if (is_logged_in()): ?>
