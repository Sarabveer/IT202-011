...
if (isset($_POST["saved"])) {
  ...
  if ($isValid) {
    $stmt = $db->prepare(
      "UPDATE Users set email = :email, username = :username, first_name = :first_name, last_name = :last_name, privacy = :privacy where id = :id"
    );
    $r = $stmt->execute([
      ":email" => $newEmail,
...
<form method="POST">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="username" name="username" maxlength="60" required value="<?php safer_echo(get_username()); ?>">
  </div>
  <div class="row">
    <div class="col-sm">
      <div class="form-group">
